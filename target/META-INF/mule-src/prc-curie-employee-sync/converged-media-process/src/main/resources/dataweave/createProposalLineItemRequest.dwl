...
---
{
	...
	proposalId: if((vars.shortSample.proposalId[0] ~= "0") or (isEmpty(vars.shortSample.proposalId[0]))) 
					vars.proposalId 
				else 
					vars.shortSample.proposalId[0],
	lineItems: vars.shortSample map ( shortSample , indexOfShortSample ) -> {
		proposalId: if((shortSample.proposalId ~= "0") or (isEmpty(shortSample.proposalId))) 
						vars.proposalId 
					else 
						shortSample.proposalId,
		lineItemDetail: {
			...
			id: shortSample.lineItemDetail.id default "0",
